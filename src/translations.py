...
def get_all_translation_languages() -> List[Tuple[str, str]]:
    """Get list of all supported translation target languages (code, name)"""
    return sorted([
        ("af", "Afrikaans / Африкаанс"),
        ("sq", "Albanian / Шкип (Албанский)"),
        ("am", "Amharic / Амарнья"),
        ("ar", "Arabic / العربية"),
        ("hy", "Armenian / Հայերեն"),
